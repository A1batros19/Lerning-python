...
#Задача 88 Последовательность символов
...
#Задача 89 Звездный прямоугольник
...
#Задача 92 Звездный треугольник
...
n=int(input()) #количество дней для размножения КОЛ-ВО ИТЕРАЦИЙ

for i in range(n):   #i - номер итерации  n - количество итераций
    itog1=m*((p/100)+1)**i
    print((i+1),itog1)
